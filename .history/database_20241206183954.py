...
def sync_user_profile(tg_id: int, username: str):
    """
    Синхронизация профиля пользователя: обновляем username, если он изменился.
    """
    existing_user = get_user_by_tg_id(tg_id)
    if existing_user and existing_user[1] != username:
