...
def add_user(tg_id: int, username: str):
    ...
    Если пользователь с таким tg_id уже существует, он не добавляется.
    """
...
def create_or_get_user(tg_id: int, username: str):
    """
    Получение пользователя из базы. Если не найден, создается новый.
    """
...
def get_reviews(target_id: int, limit: int, offset: int):
    """
    Получение отзывов пользователя с дополнительной информацией.
    """
    cursor.execute("""
