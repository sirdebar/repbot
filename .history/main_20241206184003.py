...
from database import (
    ...
    can_change_reputation, update_reputation_change_time, add_user, sync_user_profile  # добавляем add_user
)
...
async def search_user_handler(message: types.Message):
    ...
    if user_info:
        ...
        # Попытка получить реальную информацию о пользователе через Telegram API
        try:
